...
![Vexriscv_Structure](../../public/asset/vexriscv_struct.png)
*VexRiscv 插件化流水线示意图*
...
正是因为这种“插件化”的组合，你才能像搭积木一样自由组装 CPU 功能。更妙的是，最终生成的硬件零冗余——只留下你真正用到的部分，完完全全的**按需构建**。无论你是搭两级小流水线还是五级大核，同一个插件不用改一行代码就能复用。